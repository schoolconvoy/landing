          ...
          <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="flex lg:hidden">
              <button type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
                ...
                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" ariaHidden="true">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
              <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Request access <span ariaHidden="true">&rarr;</span></a>
            </div>
          </nav>
          ...
          <div class="lg:hidden" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
              <div class="flex items-center justify-between">
                <a href="#" class="-m-1.5 p-1.5">
                  <span class="sr-only">Schoolconvoy</span>
                  <Image
                    className="relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:invert"
                    src="/next.svg"
                    alt="Next.js Logo"
              ...
              <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                  ...
                  <div class="py-6">
                    <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Request access</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center">
              {/* Hero section */}
              <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">The perfect tool for managing a growing school</h1>
